    ...
    *,
    ...
    if access_mode in {"dynamic", "protected", "browser", "playwright"}:
        try:
            ...
            # Playwright not installed �?fall back to static mode
            access_mode = "static"
    ...
    # ------------------------------------------------------------------
    # Phase 6: Build chain evidence (action �?run linkage)
    # ------------------------------------------------------------------
...
def _execute_reanalyze_site(
    ...
    *,
    ...
    try:
        ...
        # Remove speculative seed_urls from the patch �?the analyzer guesses
        ...
        # Detect JSON API responses �?if the page returns JSON (not HTML),
